...
Run these checks from `.worktrees/playtest-fixes`, on branch `codex/playtest-fixes`.
The main checkout contains separate, uncommitted changes. Do not run these checks there.
...
The last command uses this worktree's shared dependency directory.
