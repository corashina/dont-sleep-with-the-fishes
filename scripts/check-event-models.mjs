...
const EVENT_SOURCES = Object.freeze({
  ...
  siren: Object.freeze({
    publicId: '7X8_6iciXvk',
    resourceId: '3d0f814b-505e-45b1-b82b-b2148653ea28',
    sha256: 'C6752A93684A1A1DAE07CBA84B7F059645A4FEF9F4963060F6E7AE41AFDC2757',
    triangles: 692,
    maxTriangles: 800,
    title: 'Mermaid',
    creator: 'Kamylle B. Grenier',
    license: 'CC-BY 3.0',
  }),
