...
const EVENT_MODEL_COMMITTED_SHA256 = Object.freeze({
  ...
  wreckageBox: 'F565D9FF4C0408280E6F45BF0B129469615C0B264E8466930489D92FA8EAD442',
  wreckageCrate: '52A28C88A7CE88FD3F4404186A5E7F543ABAE0B8D76322976CF2DBF14392996C',
  wreckagePallet: 'B4807E34A9B6FEF8EAE9DE50A5989719D0999C4477D660A69586EDBCA0E8BE3B',
});
export const POLY_PIZZA_EVENT_MODEL_SOURCES = Object.freeze(Object.fromEntries(
  EVENT_MODEL_IDS.map((id) => [id, Object.freeze({
    ...
    committedSha256: EVENT_MODEL_COMMITTED_SHA256[id],
  })]),
));
