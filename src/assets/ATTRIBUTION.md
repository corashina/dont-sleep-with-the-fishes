...
DreamNoms' Stripe the Cat model from Sketchfab under CC-BY 4.0. Models credited to
...
| captainWhiskers | `captainWhiskers.glb` | Stripe the Cat Rigged and Animated / DreamNoms | https://sketchfab.com/3d-models/stripe-the-cat-rigged-and-animated-2e3030b71a6d4b219fdc7304f8e58013 | `sketchfab:2e3030b71a6d4b219fdc7304f8e58013` | [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0/) | 1960 | 1960 | Source GLB SHA-256 `424048674AFB86D67186029B1EC4F450178CB1510C35BD415490E8152F8708FE`; removed viewer camera and lights, extracted the restrained 4.5-second stance interval as `CaptainWhiskersIdle`, pruned unused data, deduplicated, and unpartitioned. Regenerate with `node scripts/captain-whiskers-model.mjs <source.glb>`. | 2026-07-29 |
