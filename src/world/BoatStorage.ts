...
const BOAT_STORAGE_SLOTS = {
  ...
  medicalKit: [restingSlot('floor', 'medicalKit', -1.12, -0.72, 0.10)],
  ...
  umbrella: [restingSlot('floor', 'umbrella', 1.15, -0.05, 0.14, 0.5, 0.42, -0.28)],
  swimRing: [restingSlot('floor', 'swimRing', 0.95, -0.62, -0.08)],
  flashlight: [restingSlot('shelf', 'flashlight', 1.10, -1.74, 0.10)],
  harpoonGun: [restingSlot('floor', 'harpoonGun', 0.50, -0.72, Math.PI / 2 - 0.18)],
