...
const restingSlot = (
  ...
  const supportPointY = id === 'compass'
...
const BOAT_STORAGE_SLOTS = {
  ...
  // Mesh contact points support the fluke on the floor and the ring against the port hull.
  anchor: [{
    surface: 'floor',
    position: [-1.394852, LIFEBOAT_FLOOR_SURFACE_Y + 0.1875554, -0.86],
    rotation: [-1.7322121, 1.01270127, 1.76044862],
    scale: 0.5,
  }],
