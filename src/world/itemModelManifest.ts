...
const presentation = {
  ...
  ductTape: { targetLongestDimension: 0.55, rotation: [Math.PI / 2, 0, 0], offset: [0, 0, 0] },
  ...
  scubaSet: { targetLongestDimension: 0.88, rotation: [0, 0, 0], offset: [0, 0.25, 0] },
  anchor: { targetLongestDimension: 0.88, rotation: [0, 0, 0], offset: [0, 0, 0] },
  bottledPaper: { targetLongestDimension: 0.62, rotation: [0, 0, 0], offset: [0, 0, 0] },
  umbrella: { targetLongestDimension: 0.90, rotation: [0, 0, 0], offset: [0, 0, 0] },
