...
export function createProp(instance: ItemInstance): Group {
  ...
  if (type === 'flareGun') {
    ...
    const maskFrame = new Mesh(new TorusGeometry(0.16, 0.035, 6, 12), material(0x252d30, 0.3));
    ...
    root.add(leftTank, rightTank, harness, maskFrame, maskLens);
  } else {
