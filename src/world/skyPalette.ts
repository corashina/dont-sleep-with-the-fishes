...
const BASE: Record<SkyWeather, Record<SkyPhase, PaletteNumbers>> = {
  fog: {
    day: {
      zenithColor: 0x345f7e, upperColor: 0x7296a6, horizonColor: 0xb0c0bc,
      fogColor: 0x99adb0, sunColor: 0xd4cdb9, moonColor: 0xc6d0d4,
      starColor: 0xd8e0e2, ambientLightColor: 0xb5c3c3, keyLightColor: 0xcac8bd,
      sunVisibility: 0.72, moonVisibility: 0, starVisibility: 0, haze: 0.26,
      cloudCoverage: 0, cloudContrast: 0, horizonBandStrength: 0, horizonBandWidth: 0,
      exposure: 1, ambientLightIntensity: 0.82, keyLightIntensity: 0.55,
      fogDensity: 0.085, fogVolume: 1,
    },
    night: {
      zenithColor: 0x081321, upperColor: 0x172d41, horizonColor: 0x516572,
      fogColor: 0x536973, sunColor: 0xffdda0, moonColor: 0xc3ced2,
      starColor: 0xd4dcdf, ambientLightColor: 0x78959f, keyLightColor: 0x96acb8,
      sunVisibility: 0, moonVisibility: 0.9, starVisibility: 0, haze: 0.2,
      cloudCoverage: 0, cloudContrast: 0, horizonBandStrength: 0, horizonBandWidth: 0,
  ...
  calm: {
    ...
    night: {
      ...
      starColor: 0xe8eef0, ambientLightColor: 0x6f9bb1, keyLightColor: 0xa8c0ce,
  ...
  overcast: {
    day: {
      zenithColor: 0x2c5568, upperColor: 0x598493, horizonColor: 0x929b99,
    ...
    night: {
      ...
      starColor: 0xd4dcdf, ambientLightColor: 0x678da0, keyLightColor: 0x96acb8,
  ...
  squall: {
    day: {
      zenithColor: 0x153847, upperColor: 0x285565, horizonColor: 0x596064,
    ...
    night: {
      ...
      starColor: 0xb9c3c7, ambientLightColor: 0x527b8f, keyLightColor: 0x849aa7,
