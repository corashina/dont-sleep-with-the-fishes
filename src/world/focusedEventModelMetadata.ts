...
const metadata = {
  ...
  midnightCampfire: {"triangles":602,"rawBounds":{"min":[-0.20237413700670004,-0.03336616046668425,-0.1795153973728012],"max":[0.20419631619006395,0.07880607957957989,0.18286775701708274]},"animations":[]},
  midnightBush: {"triangles":360,"rawBounds":{"min":[-1.0261795483529568,-0.2886201720684767,-1.0356031358242035],"max":[1.0428105480968952,0.8996034972369671,1.0295714251697063]}},
  lighthouse: {"triangles":726,"rawBounds":{"min":[-6.915679931640625,0,-8.12823486328125],"max":[6.915679931640625,35.810813903808594,6.915679931640625]}},
  ...
  airplane: { triangles: 1770, rawBounds: { min: [-1.2133740186691284, -0.6046370267868042, -1.8883689641952515], max: [1.2133740186691284, 0.6046370267868042, 1.8883689641952515] } },
  flyingSaucer: { triangles: 3958, rawBounds: { min: [-212.18299865722656, -25.2406005859375, -212.18299865722656], max: [212.18299865722656, 83.23770141601562, 212.18299865722656] } },
