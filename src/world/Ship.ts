...
export function createShip(): ShipBuild {
  ...
  return {
    ...
    itemSpawnPoints: [
      ...
      new Vector3(-0.85, 2.35, 7.65), new Vector3(0.9, 2.35, 7.55),
      new Vector3(-0.75, 2.35, 5.45), new Vector3(0.85, 2.35, 5.4),
      new Vector3(-0.1, 2.35, 3.55), new Vector3(2.65, 2.35, 0.35),
      new Vector3(-2.65, 2.35, -0.25), new Vector3(-0.65, 2.35, -3.85),
      new Vector3(0.85, 2.35, -4.45), new Vector3(-2.55, 2.35, -9.2),
      new Vector3(1.2, 2.35, -7.7),
    ],
