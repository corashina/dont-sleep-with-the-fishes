...
export const AUDIO_MANIFEST: Readonly<Record<SoundId, AudioAssetDefinition>> =
  Object.freeze({
    ...
    // Reuse the long thunder recording as an event-owned ambience beneath the close strikes.
    stormRumble: asset('thunderLightning', 'ambience', 0.48, true),
    thunderLightning: asset('thunderLightning', 'effects', 0.9, false, 2),
    thunderLightningCrack: asset('thunderLightningCrack', 'effects', 0.9, false, 2),
    thunderLightningDry: asset('thunderLightningDry', 'effects', 0.86, false, 2),
    ...
    sinkingCreak: asset('boatCreak', 'effects', 0.64, true),
    ...
    ufoFlyby: asset('ufoFlyby', 'ambience', 0.42, true, 1, 'wav'),
    ...
    underUsPresence: asset('underUsPresence', 'ambience', 0.48, true, 1, 'wav'),
