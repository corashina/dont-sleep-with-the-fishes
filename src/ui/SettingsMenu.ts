...
export interface SettingsMenuOptions extends SettingsMarkupOptions {
  ...
  ambientOcclusion?: PostProcessingControls;
}
...
export class SettingsMenu {
  ...
  constructor(private readonly mount: HTMLElement, private readonly options: SettingsMenuOptions) {
    ...
    this.ambientOcclusionControl = options.ambientOcclusion
      ? new AmbientOcclusionQualityControl(options.ambientOcclusion) : null;
    this.qualityControls = [
      ...
      ...(this.ambientOcclusionControl ? [this.ambientOcclusionControl] : []),
    ];
