...
const ITEM_ARTWORK: Readonly<Record<ItemId, string>> = {
  ...
  knife: '<path class="item-artwork__primary item-artwork__stroke" d="M15 48l32-28 17-4-7 17-31 27z"/><path class="item-artwork__cutout item-artwork__stroke" d="M27 48l-8-8 7-7 8 8z"/><path class="item-artwork__secondary item-artwork__stroke" d="M22 43L10 55m17-7L16 59"/>',
