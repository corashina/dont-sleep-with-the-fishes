...
const ARTWORK: Record<UiArtworkId, string> = {
  ...
  chest: '<g data-chest-scale transform="translate(40 36) scale(.84 .8) translate(-40 -36)"><path d="M14 27h52v37H14z"/><path d="M16 29V14c16-6 32-6 48 0v15z"/><path class="ui-artwork__chest-hardware" d="M11 12h6v52h-6zM63 12h6v52h-6zM10 28h60v7H10zM32 26h16l4 8-5 18H33l-5-18z"/><path class="ui-artwork__chest-keyhole" transform="translate(40 42.5) scale(.5) translate(-40 -42.5)" d="M40 34c-3 0-5 2-5 5 0 2 1 4 3 5l-2 7h8l-2-7c2-1 3-3 3-5 0-3-2-5-5-5z"/><path class="ui-artwork__shine" d="M25 17c10-3 20-3 30-1"/></g>',
...
const ITEM_ARTWORK: Readonly<Record<ItemId, string>> = {
  ...
  rope: '<ellipse class="item-artwork__primary item-artwork__stroke" cx="39" cy="33" rx="29" ry="21"/><ellipse class="item-artwork__cutout item-artwork__stroke" cx="39" cy="33" rx="20" ry="13"/><ellipse class="item-artwork__secondary item-artwork__stroke-thin" cx="39" cy="33" rx="11" ry="6"/><path class="item-artwork__secondary item-artwork__stroke" d="M60 45c8 2 11 8 8 14-3 7-12 8-18 2"/>',
  ...
  radio: '<path class="item-artwork__secondary" d="M14 25h52v38H14z"/><path class="item-artwork__primary" d="M19 31h23v24H19z"/><circle class="item-artwork__light item-artwork__stroke-thin" cx="54" cy="39" r="7"/><circle class="item-artwork__light item-artwork__stroke-thin" cx="54" cy="54" r="4"/><path class="item-artwork__ink item-artwork__stroke" d="m58 25 8-18"/><path class="item-artwork__light item-artwork__stroke-thin" d="M23 36h15m-15 6h15m-15 6h15"/>',
