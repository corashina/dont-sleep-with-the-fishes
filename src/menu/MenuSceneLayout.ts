...
export const MENU_MODEL_PLACEMENTS: readonly MenuGroundPlacement[] = [
  { id: 'rock-a-1', modelId: 'rockA', position: [-6, -0.1, -4], rotation: [0, 0.4, 0], halfSize: MODEL_HALF_SIZE.rockA },
  { id: 'rock-a-2', modelId: 'rockA', position: [7, -0.25, -6], rotation: [0, -0.8, 0.08], halfSize: MODEL_HALF_SIZE.rockA },
  ...
  { id: 'rock-b-3', modelId: 'rockB', position: [-17, -0.34, -17], rotation: [0, -1.05, -0.06], halfSize: MODEL_HALF_SIZE.rockB },
  ...
  { id: 'rock-b-6', modelId: 'rockB', position: [24, -0.46, -42], rotation: [0, -0.3, 0.05], halfSize: MODEL_HALF_SIZE.rockB },
  ...
  { id: 'coral-2', modelId: 'coral', position: [4, -0.3, -8], rotation: [0, 0.65, 0], halfSize: MODEL_HALF_SIZE.coral },
  { id: 'coral-3', modelId: 'coral', position: [-12, -0.34, -8], rotation: [0, -0.9, 0], halfSize: MODEL_HALF_SIZE.coral },
  { id: 'coral-4', modelId: 'coral', position: [12, -0.35, -5], rotation: [0, 1.1, 0], halfSize: MODEL_HALF_SIZE.coral },
  { id: 'coral-5', modelId: 'coral', position: [-18, -0.42, -11], rotation: [0, 0.25, 0], halfSize: MODEL_HALF_SIZE.coral },
  ...
  { id: 'seaweed-3', modelId: 'seaweed', position: [-5, -0.32, -6.8], rotation: [0, 3.4, 0], halfSize: MODEL_HALF_SIZE.seaweed },
  ...
  { id: 'seaweed-9', modelId: 'seaweed', position: [-25, -0.43, -17], rotation: [0, 14.8, 0], halfSize: MODEL_HALF_SIZE.seaweed },
