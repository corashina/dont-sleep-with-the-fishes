...
const EVENT_CHOICE_PRIORITY = Object.freeze({
  ...
  snatcher: ['shotgun', 'rope', 'spyglass', 'swimRing', 'fishingNet', 'sleep'],
  'death-stare': ['shotgun', 'flashlight', 'umbrella', 'cannedFood', 'sleep'],
  'swarm-of-sharks': ['fishingNet', 'shotgun', 'baitTin', 'sleep'],
  tornado: ['anchor', 'swimRing', 'sleep'],
  'shower-night': ['umbrella', 'bucket', 'map', 'sleep'],
  'windy-night': ['rope', 'fishingNet', 'umbrella', 'map', 'sleep'],
  ...
  'starry-night': ['spyglass', 'compass', 'sleep'],
  'constellation-night': ['spyglass', 'compass', 'sleep'],
