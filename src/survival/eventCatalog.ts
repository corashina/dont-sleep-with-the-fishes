  ...
  event('wreckage', 'day', 'Wreckage', 'uncertain', 'dive', 1, 4, 5, [
    {
      ...contextualChoice('search', 'Search Debris',
        wreckageOutcome('wreckage.search-food', 43, 'You recover one food.',
          effects([subtract('energy', 1), add('food', 1)]), 'wreckage-search-food'),
        wreckageOutcome('wreckage.search-bait', 37, 'You recover one bait.',
    ...
    {
      ...contextualChoice('delegate-carlitos', 'Send Carlitos',
        wreckageOutcome('wreckage.search-food', 43, 'Carlitos recovers one food.',
          effects([add('food', 1)]), 'wreckage-carlitos-food'),
        wreckageOutcome('wreckage.search-bait', 37, 'Carlitos recovers one bait.',
