...
const EVENT_TEXT = {
  ...
  'eventText014': { en: 'A lone figure appears in the fog.', pl: 'We mgle pojawia się samotna postać.', 'es-AR': 'Una figura solitaria aparece en la niebla.' },
  ...
  'eventText043': { en: 'Man in the Fog', pl: 'Człowiek we mgle', 'es-AR': 'Hombre en la niebla' },
  ...
  'eventText051': { en: 'Wreckage', pl: 'Wrak', 'es-AR': 'Naufragio' },
  ...
  'eventText216': { en: 'You recover duct tape.', pl: 'Odzyskujesz taśmę naprawczą.', 'es-AR': 'Recuperás cinta adhesiva.' },
  'eventText217': { en: 'You recover one food.', pl: 'Odzyskujesz jedną porcję jedzenia.', 'es-AR': 'Recuperás una porción de comida.' },
  'eventText218': { en: 'You recover one bait.', pl: 'Odzyskujesz jedną przynętę.', 'es-AR': 'Recuperás una unidad de carnada.' },
  'eventText219': { en: 'Sharp debris cuts you.', pl: 'Ostre szczątki cię ranią.', 'es-AR': 'Los restos filosos te cortan.' },
  'eventText221': { en: 'Carlitos recovers one food.', pl: 'Carlitos odzyskuje jedną porcję jedzenia.', 'es-AR': 'Carlitos recupera una porción de comida.' },
  'eventText222': { en: 'Carlitos recovers one bait.', pl: 'Carlitos odzyskuje jedną przynętę.', 'es-AR': 'Carlitos recupera una unidad de carnada.' },
  'eventText223': { en: 'Carlitos returns empty.', pl: 'Carlitos wraca z pustymi łapami.', 'es-AR': 'Carlitos vuelve con las patas vacías.' },
  'eventText224': { en: 'You recover a medkit.', pl: 'Odzyskujesz apteczkę.', 'es-AR': 'Recuperás un botiquín.' },
  'eventText225': { en: 'You recover a flare gun.', pl: 'Odzyskujesz pistolet sygnałowy.', 'es-AR': 'Recuperás una pistola de bengalas.' },
  'eventText226': { en: 'You recover an energy bar.', pl: 'Odzyskujesz baton energetyczny.', 'es-AR': 'Recuperás una barra energética.' },
  'eventText227': { en: 'The wreck collapses around you.', pl: 'Wrak zawala się wokół ciebie.', 'es-AR': 'El naufragio se derrumba a tu alrededor.' },
  'eventText228': { en: 'The wreck collapses and damages your gear.', pl: 'Wrak zawala się i uszkadza twój sprzęt.', 'es-AR': 'El naufragio se derrumba y daña tu equipo.' },
  'eventText229': { en: 'A creature attacks inside the wreck.', pl: 'Wewnątrz wraku atakuje cię stworzenie.', 'es-AR': 'Una criatura ataca dentro del naufragio.' },
  'eventText230': { en: 'A presence follows you through the wreck.', pl: 'Jakaś obecność podąża za tobą przez wrak.', 'es-AR': 'Una presencia te sigue por el naufragio.' },
  'eventText231': { en: 'You leave the wreckage behind.', pl: 'Zostawiasz wrak za sobą.', 'es-AR': 'Dejás atrás el naufragio.' },
