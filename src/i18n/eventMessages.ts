...
const EVENT_TEXT = {
  snatcherFoodChoice: { en: 'Distract the tentacle — spend 1 Food', pl: 'Odwróć uwagę macki — zużyj 1 jedzenie', 'es-AR': 'Distraé al tentáculo — gastás 1 de comida' },
  snatcherFoodResult: { en: 'The tentacle follows the food. Your remaining supplies stay aboard.', pl: 'Macka podąża za jedzeniem. Pozostałe zapasy zostają na pokładzie.', 'es-AR': 'El tentáculo sigue la comida. Las demás provisiones quedan a bordo.' },
  schoolBaitChoice: { en: 'Lure fish alongside — spend 1 Bait, gain 2 Food', pl: 'Zwab ryby do burty — zużyj 1 przynętę, zyskaj 2 jedzenia', 'es-AR': 'Atraé peces al bote — gastás 1 de carnada, ganás 2 de comida' },
  schoolBaitResult: { en: 'Fish crowd around the bait beside the boat. You catch enough for two meals.', pl: 'Ryby gromadzą się wokół przynęty przy łodzi. Łapiesz dość na dwa posiłki.', 'es-AR': 'Los peces se juntan alrededor de la carnada junto al bote. Atrapás suficiente para dos comidas.' },
  melodyRadioChoice: { en: 'Drown out the melody with Radio static — lose 1 Energy at dawn', pl: 'Zagłusz melodię szumem radia — stracisz 1 energię o świcie', 'es-AR': 'Tapá la melodía con estática de radio — perdés 1 de energía al amanecer' },
  melodyRadioResult: { en: 'Radio static breaks the melody. You stay safe, but lose sleep keeping it on.', pl: 'Szum radia przerywa melodię. Jesteś bezpieczny, ale tracisz sen, pilnując radia.', 'es-AR': 'La estática corta la melodía. Estás a salvo, pero perdés sueño manteniendo la radio encendida.' },
  deathStareFlareChoice: { en: 'Repel the creature — spend the Flare Gun', pl: 'Odstrasz stworzenie — zużyj rakietnicę', 'es-AR': 'Ahuyentá a la criatura — gastás la pistola de bengalas' },
  deathStareFlareResult: { en: 'The flare burns before its eyes. The creature breaks its stare and sinks away.', pl: 'Flara płonie przed jego oczami. Stworzenie odwraca wzrok i zanurza się.', 'es-AR': 'La bengala arde frente a sus ojos. La criatura aparta la mirada y se hunde.' },
  wavesTapeChoice: { en: 'Tape down supplies — spend Tape; take 10–20 hull damage', pl: 'Przyklej zapasy — zużyj taśmę; kadłub straci 10–20 punktów', 'es-AR': 'Sujetá las provisiones — gastás cinta; el casco pierde 10–20 puntos' },
  wavesTapeResult: { en: 'The tape keeps your supplies aboard. Waves still batter the hull.', pl: 'Taśma utrzymuje zapasy na pokładzie. Fale nadal uderzają w kadłub.', 'es-AR': 'La cinta mantiene las provisiones a bordo. Las olas igual golpean el casco.' },
  ...
  starryNightGift: {"en":"The stars shine on. Their gift rests in your boat.","pl":"Gwiazdy nadal świecą. Ich dar spoczywa w twojej łodzi.","es-AR":"Las estrellas siguen brillando. Su regalo descansa en tu bote."},
  ...
  snatcherKnifeBroke: { en: 'The knife snaps as you cut the tentacle. Your supplies stay aboard.', pl: 'Nóż pęka, gdy odcinasz mackę. Zapasy zostają na pokładzie.', 'es-AR': 'El cuchillo se rompe al cortar el tentáculo. Tus provisiones quedan a bordo.' },
  wavesAnchorBroke: { en: 'The anchor steadies the boat, then breaks under the strain. The hull stays intact.', pl: 'Kotwica stabilizuje łódź, po czym pęka pod naporem. Kadłub pozostaje cały.', 'es-AR': 'El ancla estabiliza el bote y después se rompe por la tensión. El casco queda intacto.' },
  ...
  sharksFoodChoice: { en: 'Throw 1 Food — take 10–20 hull damage', pl: 'Rzuć 1 jedzenie — kadłub straci 10–20 punktów', 'es-AR': 'Tirá 1 de comida — el casco pierde 10–20 puntos' },
  sharksFoodResult: { en: 'The sharks swim away from the boat and circle the food.', pl: 'Rekiny odpływają od łodzi i krążą wokół jedzenia.', 'es-AR': 'Los tiburones se alejan del bote y nadan en círculos alrededor de la comida.' },
  ...
  'eventText073': { en: 'Offer 1 Food', pl: 'Daj 1 jedzenie', 'es-AR': 'Ofrecé 1 de comida' },
  ...
  'eventText155': { en: 'The wind pulls the map away.', pl: 'Wiatr porywa mapę.', 'es-AR': 'El viento se lleva el mapa.' },
  ...
  'eventText176': { en: 'The figure bites the boat.', pl: 'Postać gryzie łódź.', 'es-AR': 'La figura muerde el bote.' },
  'eventText177': { en: 'The figure bites through the hull.', pl: 'Postać przegryza kadłub.', 'es-AR': 'La figura muerde y rompe el casco.' },
