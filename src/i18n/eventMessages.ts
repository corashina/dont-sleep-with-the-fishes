...
const EVENT_TEXT = {
  ...
  krakenReturnHeart: { en: 'Return the Heart of the Sea', pl: 'Zwróć Serce Morza', 'es-AR': 'Devolvé el Corazón del Mar' },
  krakenReturned: { en: 'The heart sinks into the deep. The Kraken releases the boat. Your debt is paid.', pl: 'Serce opada w głębinę. Kraken uwalnia łódź. Twój dług został spłacony.', 'es-AR': 'El corazón se hunde. El Kraken libera el bote. Tu deuda está saldada.' },
  ...
  ufoBeamHit: { en: 'The disc stops above you. A cold beam burns through you, but leaves you on the boat.', pl: 'Dysk zatrzymuje się nad tobą. Zimny promień przeszywa cię bólem, ale zostawia na łodzi.', 'es-AR': 'El disco se detiene sobre vos. Un haz frío te quema, pero te deja en el bote.' },
  ...
  flowersCollectResult: { en: 'You reach between the flowers and lift out a piece of the Heart of the Sea.', pl: 'Sięgasz między kwiaty i wyciągasz fragment Serca Morza.', 'es-AR': 'Metés la mano entre las flores y sacás un fragmento del Corazón del Mar.' },
  ...
  'eventText147': { en: 'The boat is badly damaged.', pl: 'Łódź zostaje ciężko uszkodzona.', 'es-AR': 'El bote sufre daños graves.' },
  ...
  eventText237: { en: 'The net lifts a piece of the Heart of the Sea from between the flowers.', pl: 'Sieć wyciąga fragment Serca Morza spomiędzy kwiatów.', 'es-AR': 'La red saca un fragmento del Corazón del Mar de entre las flores.' },
  eventText238: { en: 'You scoop a piece of the Heart of the Sea into the bucket. The flowers drift away.', pl: 'Wyławiasz fragment Serca Morza wiadrem. Kwiaty odpływają.', 'es-AR': 'Recogés un fragmento del Corazón del Mar con el balde. Las flores se alejan.' },
  ...
  eventTestSupplyBarrel: { en: 'Drifting Supplies: Barrel', pl: 'Dryfujące zapasy: beczka', 'es-AR': 'Suministros a la deriva: barril' },
  eventTestSupplyLifeboat: { en: 'Drifting Supplies: Lifeboat Cooler', pl: 'Dryfujące zapasy: lodówka z szalupy', 'es-AR': 'Suministros a la deriva: conservadora de bote salvavidas' },
  eventTestSupplyContainer: { en: 'Drifting Supplies: Shipping Container', pl: 'Dryfujące zapasy: kontener transportowy', 'es-AR': 'Suministros a la deriva: contenedor de carga' },
  eventTestSupplyDebris: { en: 'Drifting Supplies: Debris', pl: 'Dryfujące zapasy: szczątki', 'es-AR': 'Suministros a la deriva: restos' },
