...
const situations: Record<string, readonly [string, string, string]> = {
  ...
  'restless-waves': ['The waves kept rocking the boat.', 'Fale bez przerwy kołysały łodzią.', 'Las olas sacudían el bote sin parar.'],
  ...
  handyman: ['', '', ""],
  'other-people': ['', '', ""],
  'ghost-ship': ['An empty ship glowed green beside us. Its sails hung still.', 'Obok nas płynął pusty statek, świecąc na zielono. Jego żagle wisiały nieruchomo.', 'Un barco vacío brillaba verde a nuestro lado. Sus velas colgaban inmóviles.'],
  plane: ['', '', ""],
...
const attempts: Record<string, readonly [string, string, string]> = {
  ...
  'death-stare.cannedFood': ['I threw food towards it, but it kept coming.', 'Rzuciłem mu jedzenie, ale nadal się zbliżało.', 'Le tiré comida, pero siguió acercándose.'],
