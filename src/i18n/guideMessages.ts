...
export const guideText = defineMessages({
  ...
  driftingBody: {
    ...
    pl: "Wybierz dryfujące zapasy przed nocą: zebranie zwykłych zapasów kosztuje ⚡1, a skrzyni ⚡1. Szczątki zbierasz na tych samych zasadach. Ładunek może zawierać jedzenie i przynętę, zwykłe zapasy oraz najwyżej jeden cenny przedmiot. Każdą odzyskaną skrzynię otworzysz raz w szalupie, aby zdobyć nagrodę za ⚡3. Zamknięta przez kilka nocy skrzynia grozi atakiem. Wybierz sprawny sprzęt do nurkowania, aby zanurkować za ⚡3. Możesz znaleźć 1–3 porcje jedzenia, 1–3 przynęty lub ślady przybliżające ratunek. Znaleziska po trzy sztuki są niezwykle rzadkie. Ryzykujesz utratę 15–45 punktów zdrowia, nawet ze zdobyczą. Zachmurzenie pogarsza szanse, a szkwał blokuje nurkowanie.",
