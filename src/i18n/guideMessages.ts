...
export const guideText = defineMessages({
  ...
  driftingBody: {
    ...
    pl: "Wybierz dryfujące zapasy przed nocą: zebranie zwykłych zapasów kosztuje ⚡1, a skrzyni ⚡3. Przeszukanie wraku kosztuje ⚡1 i grozi obrażeniami. Każdą odzyskaną skrzynię otworzysz raz w szalupie, aby zdobyć nagrodę bez kosztu energii. Zamknięta przez kilka nocy skrzynia grozi atakiem. Wybierz sprawny sprzęt do nurkowania, aby zanurkować za ⚡3. Możesz znaleźć 1–3 porcje jedzenia, 1–3 przynęty lub ślady przybliżające ratunek. Znaleziska po trzy sztuki są niezwykle rzadkie. Ryzykujesz utratę 15–45 punktów zdrowia, nawet ze zdobyczą. Zachmurzenie pogarsza szanse, a szkwał blokuje nurkowanie.",
