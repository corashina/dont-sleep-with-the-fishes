...
const eventProbeNames: Readonly<Record<DedicatedEventId, string>> = {
  leak: 'leak-hole-1',
...
const itemDurations: Readonly<Record<DedicatedEventId, number>> = {
...
)) as readonly (readonly [DedicatedEventId, keyof typeof itemTypes])[];
