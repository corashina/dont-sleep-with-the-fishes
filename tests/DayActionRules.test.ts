...
const baseRuleState: DayActionRuleState = Object.freeze({
  ...
  inventory: Object.freeze({
    ...
    'bottledPaper-1': Object.freeze({ instanceId: 'bottledPaper-1', type: 'bottledPaper', condition: 'usable' }),
...
describe('day action availability rules', () => {
  it.each([
    ...
    ['sendMessage', { rescueMessageSent: true }, undefined, 'You already sent the rescue message.'],
    ['sendMessage', { inventory: withoutItem('bottledPaper-1') }, undefined, 'No bottled paper remains.'],
    ['sendMessage', { energy: 0 }, undefined, 'Sending the message requires one energy.'],
...
describe('day action resource rules', () => {
  it.each([
    ...
    ['sendMessage', undefined, { energy: -1, rescueProgress: 15 }],
